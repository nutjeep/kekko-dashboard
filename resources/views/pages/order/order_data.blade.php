    ...
    <div class="row">
      <div class="col-lg-4 section-left">
        <div class="card p-3 shadow-sm">
          ...
          <div class="form-group mb-3">
            ...
            <input type="text" id="customer_phone" inputmode="numeric" class="form-control" placeholder="Ex: 081234567899" required>
          </div>

          <div id="invitation_type" class="mb-3">
            <h3 class="h5">Tipe Undangan</h3>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="invitation_type" id="printed_invitation" value="undangan_cetak" checked>
              <label class="form-check-label" for="printed_invitation">
                Cetak
              </label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="invitation_type" id="digital_invitation" value="undangan_digital">
              <label class="form-check-label" for="digital_invitation">
                Digital
              </label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="invitation_type" id="printed_digital" value="cetak_digital">
      ...
      <div class="col-lg-8 section-right">
        <div class="card p-3 shadow-sm">
          <div class="data-pengantin">
            ...
            <div class="groom"> 
              ...
              <div class="form-group mb-3">
                ...
                <input type="text" id="groom_number_child" class="form-control" placeholder="Cth: Pertama / Kedua" name="groom_number_child" required>
              </div>
              <div class="form-group mb-3">
              ...
              <div class="form-group mb-3">
                ...
                <input class="form-control" placeholder="Cth: 08123456789" inputmode="numeric">
              </div>
              <div class="mb-3">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="groom_instagram" name="" class="form-control" placeholder="Cth: dian_febrian" aria-label="Username" aria-describedby="basic-addon1">
                </div>
              </div>
            </div>
            ...
            <div class="bride">
              ...
              <div class="form-group mb-3">
                ...
                <input class="form-control" placeholder="Cth: 08123456789" inputmode="numeric" name="bride_phone">
              </div>
              <div class="mb-3">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="bride_instagram" name="bride_instagram" class="form-control" placeholder="Cth: asmara.dita" aria-label="Username" aria-describedby="basic-addon1">
                </div>
              </div>
            </div>
          </div>
          ...
          <h2 class="text-center mb-3">Pilih Acara</h2>
