<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="product" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="cards.html">Paket</a>
                <a class="collapse-item" href="cards.html">Tema</a>
                <a class="collapse-item" href="cards.html">Addon</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="setting" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                {{-- <h6 class="collapse-header">Custom Components:</h6> --}}
                <a class="collapse-item" href="buttons.html">Role User</a>
                <a class="collapse-item" href="cards.html">Hak Akses</a>
            </div>
        </div>
    </li>
